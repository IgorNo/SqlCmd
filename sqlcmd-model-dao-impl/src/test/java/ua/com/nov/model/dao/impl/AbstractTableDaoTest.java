...
public abstract class AbstractTableDaoTest {
    ...
    protected static void createTestData(String catalog, String schema, String aiTypeName) throws DaoSystemException, DaoBusinesException {
    ...
    @Before
    public void setUp() throws DaoSystemException, DaoBusinesException {
        tearDown();
    ...
    @Test
    public void testReadTableMetaData() throws DaoSystemException, DaoBusinesException {
    ...
    @Test
    public void testRenameTable() throws DaoBusinesException, DaoSystemException{
    ...
    @Test(expected = DaoBusinesException.class)
    public void  testDeleteTable() throws DaoSystemException, DaoBusinesException {
    ...
    @Test
    public void testAddColumn() throws DaoSystemException, DaoBusinesException {
    ...
    @Test
    public void testReadColumn() throws DaoBusinesException, DaoSystemException {
    ...
    @Test
    public void testRenameColumn() throws DaoSystemException, DaoBusinesException {
        Column testCol = customers.getColumn("name");
    ...
    public void  testDeleteColumn() throws DaoSystemException, DaoBusinesException {
    ...
    @Test
    public void testDeleteAddReadPrimaryKey() throws DaoSystemException, DaoBusinesException {
    ...
    @Test
    public void testRenamePrimaryKey() throws DaoSystemException, DaoBusinesException {
    ...
    @Test
    public void testDeleteAddReadForeignKey() throws DaoSystemException, DaoBusinesException {
    ...
    @Test
    public void testRenameForeignKey() throws DaoSystemException, DaoBusinesException {
    ...
    @Test
    public void testDeleteAddReadUniqueKey() throws DaoSystemException, DaoBusinesException {
    ...
    @Test
    public void testRenameUniqueKey() throws DaoSystemException, DaoBusinesException {
    ...
    @Test
    public void testDeleteAddReadIndex() throws DaoSystemException, DaoBusinesException {
    ...
    @After
    public void tearDown() throws DaoSystemException, DaoBusinesException {
        List<Table> tables = TABLE_DAO.readAll(schemaId);
